...
import com.example.dungeondifficultyaddition.mixin.ItemScalingInvoker;
...
final class DungeonDifficultyNativeScaling {
    ...
    static boolean apply(ItemStack stack, int level) {
        ...
        ItemScalingInvoker.ddJewelryCompat$applyModifiersForItemStack(
                inferred.slots(),
    ...
    private static boolean isMagicWeapon(ItemStack stack) {
        if (OptionalModSupport.isLoaded("spell_engine")
